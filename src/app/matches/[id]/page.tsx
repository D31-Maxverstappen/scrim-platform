    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <div className="pt-28 max-w-5xl mx-auto px-6 py-8">
        ...
        {match.discord_channel_id && match.status !== 'completed' && (
          <a
            href={`https://discord.com/channels/${process.env.NEXT_PUBLIC_DISCORD_GUILD_ID}/${match.discord_channel_id}`}
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4 bg-[#1e1e2e] border border-[#5865F2]/30 rounded px-5 py-4 mb-4 hover:border-[#5865F2]/60 transition group"
          >
            ...
            <div className="flex-1">
              <p className="text-white font-bold text-sm">스크림 음성채널 열려 있음</p>
              <p className="text-slate-500 text-xs">클릭해서 Discord 음성채널로 이동 · 양 팀 멤버만 보임</p>
            </div>
