            ...
            {posts.map((post: any) => {
              ...
              return (
                <a key={post.id} href={`/scrims/${post.id}`}
                  className="bg-[#13131f] border border-white/5 hover:border-[#c89b3c]/40 rounded px-6 py-4 flex items-center gap-4 transition group">
                  <div className="w-2 h-12 rounded-full shrink-0 bg-[#c89b3c]" />
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {post.format && (
                        <span className="text-[10px] font-black bg-[#c89b3c]/10 text-[#c89b3c] px-1.5 py-0.5 rounded">{post.format}</span>
                      )}
                    </div>
                  ...
                  <span className="text-[#c89b3c] text-xs font-bold shrink-0">신청하기 →</span>
                </a>
              )
            })}
          </div>
